...
const D: Dict = {
  ...
  doorStoryDesc: { bg: "Нежна история за сладки сънища", en: "For bedtime listening — with pictures and voice", de: "Zum Einschlafen — mit Bildern und Stimme", fr: "À écouter avant de dormir — avec images et voix", ru: "Для прослушивания перед сном — с картинками и голосом" },
  ...
  doorComicDesc: { bg: "Екшън комикс с твоя малък герой", en: "Full comic pages with dialogue and action", de: "Ganze Comicseiten mit Dialogen und Action", fr: "Des pages de BD complètes avec dialogues et action", ru: "Целые страницы комиксов с репликами и экшеном" },
  ...
  micro3: { bg: "Запазена в библиотеката", en: "Saved in your library", de: "In deiner Bibliothek gespeichert", fr: "Gardée dans ta bibliothèque", ru: "Сохранится в библиотеке" },
  ...
  demoBody: { bg: "Това беше безплатната мостра. Отключи неограничени приказки и комикси в уеб версията.", en: "That was the free taster. Unlock unlimited stories and comics on the web.", de: "Das war die kostenlose Kostprobe. Schalte unbegrenzte Geschichten und Comics im Web frei.", fr: "C'était l'aperçu gratuit. Débloque des histoires et BD illimitées sur le web.", ru: "Это была бесплатная проба. Открой безлимитные сказки и комиксы в веб-версии." },
  ...
  demoUnlockWeb: { bg: "Отключи уеб достъп", en: "Unlock web access", de: "Webzugang freischalten", fr: "Débloquer l'accès web", ru: "Открыть веб-доступ" },
  ...
  footerTagline: { bg: "Персонализирани приказки и комикси с изкуствен интелект — твоето дете е героят.", en: "Personalised AI stories and comics — your child is the hero.", de: "Personalisierte KI-Geschichten und Comics — dein Kind ist der Held.", fr: "Histoires et BD personnalisées par IA — ton enfant est le héros.", ru: "Персональные сказки и комиксы с ИИ — ваш ребёнок главный герой." },
  footerRights: { bg: "Всички права запазени", en: "All rights reserved", de: "Alle Rechte vorbehalten", fr: "Tous droits réservés", ru: "Все права защищены" },
  ...
  libSub: { bg: "запазени в твоята библиотека", en: "saved in your library", de: "in deiner Bibliothek gespeichert", fr: "gardées dans ta bibliothèque", ru: "сохранены в вашей библиотеке" },
  libCount: { bg: "творби", en: "creations", de: "Werke", fr: "créations", ru: "работ" },
  ...
  libEmptyComics: { bg: "Още няма запазени комикси. Нарисувай първия!", en: "No saved comics yet. Draw the first one!", de: "Noch keine gespeicherten Comics. Zeichne den ersten!", fr: "Pas encore de BD enregistrée. Dessine la première !", ru: "Пока нет сохранённых комиксов. Нарисуй первый!" },
  libEmptyStories: { bg: "Още няма запазени приказки. Създай първата!", en: "No saved stories yet. Create the first one!", de: "Noch keine gespeicherten Geschichten. Erstelle die erste!", fr: "Pas encore d'histoires enregistrées. Crée la première !", ru: "Пока нет сохранённых сказок. Создай первую!" },
