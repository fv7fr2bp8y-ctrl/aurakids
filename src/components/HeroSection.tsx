      ...
      <div className="ak-col">
        ...
        <div className="home-nav">
          <button className="brandrow" onClick={onHome} aria-label="Начало"
            ...
            <Image src={`${ASSETS}/logo-mark-v4.png`} alt="AuraKids" width={56} height={56} unoptimized
          ...
          <div className="portal-body">
            ...
            <div className="portal-doors" data-rise style={{ animationDelay: ".26s" }}>
              <button className="portal-door" onClick={onStartStory}>
                <div className="portal-door-img pos-bottom"><DoorImage kind="story" /><span className="portal-fade" /></div>
              ...
              <button className="portal-door" onClick={onStartComic}>
                <div className="portal-door-img pos-top"><DoorImage kind="comic" /><span className="portal-fade" /></div>
                <div className="portal-door-foot">
                  <div style={{ minWidth: 0 }}>
