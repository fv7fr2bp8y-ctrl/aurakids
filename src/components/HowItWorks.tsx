const STEPS = [
  {
    number: "01",
    title: "Назови героя",
    desc: "Кажи ни името на детето и на колко години е. Само то ще е главният герой — никое друго дете в света.",
    color: "#FF6B6B",
  ...
  },
  {
    number: "02",
    title: "Избери свят",
    desc: "Дракони и замъци, тайна гора, космос, подводно царство — шест вълшебни свята, в които героят ще се впусне.",
    color: "#FFD93D",
  ...
  },
  {
    ...
    desc: "Най-мощният AI на света пише история, в която детето ви се изправя срещу предизвикателство и побеждава. С уникални илюстрации.",
    color: "#9B6FE8",
  ...
  },
  {
    number: "04",
    title: "Чуй я на глас",
    desc: "Истински топъл глас разказва приказката. Слушайте я заедно всяка вечер — тя е ваша завинаги.",
    color: "#4FC3F7",
