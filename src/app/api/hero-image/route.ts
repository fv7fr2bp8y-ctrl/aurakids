...
const HERO_FILE = "hero-main-v10.png";
const HERO_PROMPT =
  "Disney watercolor illustration, soft painterly brushstrokes: an adorable child with big expressive eyes and a tiny golden crown riding a friendly glowing purple dragon through a magical night sky. Fantasy kingdom below with glowing castles and thousands of twinkling stars. Rich purple, coral and gold watercolor washes, enchanting fairy-tale mood, ultra-detailed, no text, no watermarks.";
