...
export default function manifest(): MetadataRoute.Manifest {
  ...
  return {
    ...
    lang: "bg",
    icons: [
      { src: `/api/icon?size=192&app=${v}`, sizes: "192x192", type: "image/png", purpose: "any" },
      { src: `/api/icon?size=512&app=${v}`, sizes: "512x512", type: "image/png", purpose: "any" },
      { src: `/api/icon?size=192&app=${v}&padded=1`, sizes: "192x192", type: "image/png", purpose: "maskable" },
      { src: `/api/icon?size=512&app=${v}&padded=1`, sizes: "512x512", type: "image/png", purpose: "maskable" },
    ],
  };
}
