...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: `/api/icon?size=32&app=${IV}`, sizes: "32x32", type: "image/png" },
      { url: `/api/icon?size=192&app=${IV}`, sizes: "192x192", type: "image/png" },
      { url: `/api/icon?size=512&app=${IV}`, sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: `/api/icon?size=180&app=${IV}`, sizes: "180x180", type: "image/png" }],
    shortcut: `/api/icon?size=192&app=${IV}`,
  },
  openGraph: {
    title: TITLE,
    description: DESC,
